...
function Main() {
  return (
    <main>
      <div className="lead-div container">
        <img
          alt="docp-logo"
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 col-sm-12">
              <p>    We also help doctors to better manage their practice and build
      ...
      <div />
      <div className="container">
      <div className="fade-element-div row">
        <div className="col-md-6 col-sm-12">
        <Service
          title="For patients"
          description="Find a doctor, book a visit and solve any health-related doubt"
          link="https://www.docplanner.com/img/screen-marketplace@2x.png"
          selection={selectSection}
          color="#00ccb1"
        />
        </div>
       <div className="col-md-6 col-sm-12">
       <Service
          ...
          link="https://www.docplanner.com/img/screen-saas@2x.png"
          color="#3d83df"
        />
       </div>
      ...
      <div class="brand-div st-current st-hover container  justify-content-between">
        
        <h1 class="col-md-4 col-sm-12">
          We are a global company <br /> with local culture
        </h1>
        <ul class="brands__logos col-md-7 col-sm-12">
          <li>
      ...
      <div class="stats">
        <div class="stats-div  container">
          ...
          <div class="stats-col">
            <div class="grid">
              <Stat link="https://www.docplanner.com/img/flag.png"
               title="Leader in 10 countries"
                description="Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil,
                  Colombia, Argentina and Chile"/>
              
              <Stat link="https://www.docplanner.com/img/patients.png"
              title="30 million unique patients"
               description=" visit us every month"/>
            </div>
            <div class="grid">
              <Stat link="https://www.docplanner.com/img/visits.png"
              title="1.5 million appointments"
               description=" booked last month"/>

              <Stat link="https://www.docplanner.com/img/doctors.png"
      ...
      <div class="offices-slider">
        <Office img="https://www.docplanner.com/images/warsaw.png"
            lieu="warsaw"/>
 
 <Office img="https://www.docplanner.com/images/barcelona.png"
            lieu="Barcelona"/>
  
  <Office img="https://www.docplanner.com/images/istanbul.png"
            lieu="Istanbul"/>
 
 <Office img="https://www.docplanner.com/images/rome.png"
            lieu="Rome"/>

 
<Office img="https://www.docplanner.com/images/mexico-city.png"
            lieu="Mexico City"/>

<Office img="https://www.docplanner.com/images/curitiba.png"
            lieu="Curitiba"/>
